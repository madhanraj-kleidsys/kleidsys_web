...
| Phase | Time | Animation| Phase | Time | Animation |
|-------|------|-----------|
| **1** | 0-0.8s | Logo hangs from top with swing-in |
| **2** | 0.8-1.4s | Elastic bounce effect |
| **3** | 1.4-7s | Gentle floating animation |
| **4** | 2.2-5.2s | SVG paths draw sequentially with white stroke |
| **5** | 4.8-5.5s | Dual-color fill (dark blue then bright blue) |
| **6** | 5.5s | Text reveals with 3D letter-by-letter animation |
| **7** | 7.2-8.4s | **Shutter slides up** (main content revealed) |
| **8** | 8.4s+ | Hero title animates with 3D entrance |

### ✨ **Features:**

✅ **Hanging Bounce** - Dynamic entrance with elastic rebound  
✅ **Stroke Drawing** - Smooth SVG path animation  
✅ **Dual Color Fill** - Sequential color reveals  
✅ **Text Reveal** - 3D letter-by-letter with glow  
✅ **Shutter Effect** - Smooth slide-up transition  
✅ **Responsive** - Works perfectly on all devices  
✅ **Performance** - Optimized with `will-change`  
 🚀
 const BRAND_COLORS = {
    primary: '#002060',      // Deep corporate blue
    secondary: '#00aff0',    // Bright accent blue  
    accent: '#1e40af',       // Mid blue
...
<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="1935px" height="854px" viewBox="0 0 1935 854" preserveAspectRatio="xMidYMid meet">
 <g fill="#002060">
