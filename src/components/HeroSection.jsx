...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    const heroScrollTrigger = gsap.to(image, {
      scrollTrigger: {
        ...
        markers: false,
        onUpdate: (self) => {
          // Ensure self is defined and has progress property
          if (self && typeof self.progress !== "undefined") {
    ...
    return () => {
      if (heroScrollTrigger.scrollTrigger) {
