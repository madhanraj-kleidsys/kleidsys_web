      ...
      <Container className="reveal-section skew-section" sx={{ mb: 14 }}>
        ...
        >
          ...
          <Box flex={1} textAlign="center">
            <img src="https://ppl-ai-code-interpreter-files.s3.amazonaws.com/web/direct-files/7a98bca6c8a8ab7d0c58eab100af6517/c94c6baa-eafc-4f1d-aabc-078750e3036a/033b5e3c.png"
              alt="Modern ERP Foundation" className="about-img"
      ...
      <Container className="reveal-section skew-section" sx={{ mb: 14 }}>
        ...
        >
          ...
          <Box flex={1}>
            ...
            >
 Digital technologies are transforming the apparel supply chain and manufacturing by challenging old operating models. We Kleidsys Technologies transforming the apparel supply chain from design, manufacturing, distribution and sales into digital technology            </Typography>
          </Box>
        </Stack>
      </Container>
