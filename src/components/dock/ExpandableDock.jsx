...
const ExpandableDock = () => {
    ...
    // Animate K logo paths (drawing animation happens automatically via useEffect)
    // Show content
    .to(
        contentRef.current,
        {
    ...
    .from(
        ...
        // Hide KLEIDSYS logo
        // tl.to(kleidsysLogoRef.current, {
        //     opacity: 0,
        //     scale: 0,
        //     duration: 0.3,
        // }) 
        //     // Expand navbar downward
    ...
    const socialLinks = [
        ...
        {icon: FaEnvelope , color:'#22d3ee', label: 'Email' },
    ];
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    >
                        {!isOpen && (
                            //  <ElasticKleidsysSVG onClick={toggleDock} />
                            <svg
                                width="200"
                                height="40"
                ...
                {isOpen && (
                    ...
                    >
                        {/* K Logo (centered, visible when expanded) */}
                        {/* <Box
                            sx={{
                                // display: 'center',
                                // alignItems: 'center',
